...
> ⚠️ **ภาพนิ่งก่อนส่งมอบ — ไม่ตามสคีมาสด** · **`role` ในไฟล์นี้ (STAFF/REQUESTER) เป็นชุดเก่า**
> ระบบปัจจุบันใช้ Admin/Manager/Operator/Viewer · อย่าใช้กฎ role หรือคำสั่ง setup จากไฟล์นี้กับ
> repo ปัจจุบัน — กติกาที่มีผลจริงดู [`../../CLAUDE.md`](../../CLAUDE.md) ข้อ 4-5 · ฉบับมีชีวิตของ
> data dictionary คือ [`data_dictionary.md`](data_dictionary.md)
