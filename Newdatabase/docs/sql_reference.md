...
> ⚠️ **ภาพนิ่งก่อนส่งมอบ — ไม่ตามสคีมาสด** · **`role` ในไฟล์นี้เป็นชุดเก่า (STAFF/REQUESTER)** —
> ระบบปัจจุบันใช้ Admin/Manager/Operator/Viewer · **ห้ามรัน `prisma migrate reset` ที่แนะนำในข้อ
> ท้ายไฟล์กับ repo ปัจจุบันเด็ดขาด** (ได้ฐานเปล่า ฝั่งนี้ไม่มี seed กู้คืน — CLAUDE.md ข้อ 3) ·
> กติกาที่มีผลจริงดู [`../../CLAUDE.md`](../../CLAUDE.md) · โครงสร้างฉบับมีชีวิต `server/prisma/schema.prisma`
