   ...
   **ผูก user id เป็น FK ตามธรรมเนียมฐานใหม่ ไม่ใช่ username แบบ reference**) —
   ...
   - [ ] **เฟส 3 ยกหน้าบ้านทั้งชุด** — ตกลง 11 ก.ค. 2026: หน้าบ้าน**ใช้วิธี copy จาก reference แล้ว
     ...
     - [x] ✅ **3B หน้าหลัก 4 หน้า+สแกนเนอร์ (เสร็จ 11 ก.ค. 2026, 8 commits):** เตรียม server 4 ก้อนก่อน
       ...
       (3) **ตัวกรอง "เฉพาะสต็อกต่ำ"/"เฉพาะสต็อกต่ำ" ใน Products ต้องมีคำค้นด้วยถึงจะเจอของนอก
       500 ตัวแรก** — ไม่ใช่บั๊กของ 3B (ข้อจำกัด `limit=500` เดิมที่มีอยู่แล้ว, reference ก็เป็นแบบนี้)
       แต่พึงระวังเวลาอธิบายผู้ใช้ว่าทำไมกดฟิลเตอร์แล้วเหมือนไม่เจออะไร ทั้งที่ dashboard บอกมี
