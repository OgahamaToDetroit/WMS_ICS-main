   ...
   **ผูก user id เป็น FK ตามธรรมเนียมฐานใหม่ ไม่ใช่ username แบบ reference**) —
   ...
   - [ ] **เฟส 3 ยกหน้าบ้านทั้งชุด** — ตกลง 11 ก.ค. 2026: หน้าบ้าน**ใช้วิธี copy จาก reference แล้ว
     ...
     - [x] ✅ **3C ชุด PWA+Push (เสร็จ 11 ก.ค. 2026):** copy `public/` ทั้งชุดจาก reference (icon-192/512
       ...
       ฝั่ง server ผ่านครบ 89 ตัวเหมือนเดิม (เซสชันนี้ไม่แตะ server เลย) · ไม่มี util ใหม่ที่เป็น JS ล้วน
       ต้องเขียนเทสต์เพิ่ม (InstallPrompt/Settings เป็น UI component ล้วน ตรวจด้วย browser พอ)
   - [x] ✅ **เฟส 4 ตรวจรวม (เสร็จ 11 ก.ค. 2026):** `npm test` ผ่านครบ 89 ตัว (ไม่เพิ่ม/ไม่ลด — เซสชันนี้
