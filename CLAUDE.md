...
- **QR:** parser (`src/utils/qr.js`) + สแกนป้ายเดิมเข้าหน้า **Products** เสร็จแล้ว (`d6b0d00`/`ccd635b`) ·
  เหลือ **พิมพ์ป้าย QR** · ใช้ parser เดียวกันในจุดสแกนอื่น (Inventory ยังสแกนแบบ raw code เดิม) ·
  รูปแบบป้าย*ของใหม่*ยังไม่เคาะ (`qr_spec.md` ข้อ 5.3) · edge cases parser อยู่ `qr_spec.md` ข้อ 6
