...
รับเข้า–เบิกออก–อนุมัติ–ส่งมอบ, SSE, PWA และ Web Push (ตรวจรวมล่าสุด 11 ก.ค. 2026)
— หมายเหตุ: Web Push ทดสอบได้ถึงระดับ UI/subscription แล้ว แต่ **delivery ถึงเครื่องจริง
ยังไม่เคยพิสูจน์** (ข้อจำกัด sandbox — ดู CLAUDE.md ข้อ 6)
...
npm --prefix server run create-admin # เฉพาะฐานใหม่ที่ยังไม่มี Admin (upsert รันซ้ำได้)
```
